...
exports.StrikeModalManager = void 0;
const vscode = __importStar(require("vscode"));
class StrikeModalManager {
    static currentPanel;
    static extensionUri;
    static onCommissionCopilotCallback;
    static onVerifyHardwareCallback;
    static onSubmitPleaCallback;
    static onSpeakTextCallback;
    static onPayLeaseCallback;
    static onReadyForNarrationCallback;
    static initialize(extensionUri, onCommissionCopilot, onVerifyHardware, onSubmitPlea, onPayLease, onReadyForNarration, onSpeakText) {
    ...
    static showStrikeDecree(reversals, portName, coins = 0, activeLeaseSeconds = 0, agreedCost = 1, agreedLeaseSeconds = 180) {
        ...
        const panel = vscode.window.createWebviewPanel("nokkukooliStrikeDecree", "Office Lock Notice", column || vscode.ViewColumn.One, {
            enableScripts: true,
            retainContextWhenHidden: true,
            localResourceRoots: [this.extensionUri],
        });
        this.currentPanel = panel;
        panel.webview.html = this.getHtmlForWebview(reversals, portName, coins, activeLeaseSeconds, agreedCost, agreedLeaseSeconds);
     ...
     */
    static sendStrikeNarration(audioDataUri) {
        if (this.currentPanel) {
            this.currentPanel.webview.postMessage({
    ...
    static sendConciliatorReply(replyText, permitSeconds, leaseSeconds, coinCost, audioUrl) {
        if (this.currentPanel) {
            this.currentPanel.webview.postMessage({
    ...
    static sendTextSpeech(audioUrl) {
        if (this.currentPanel) {
            this.currentPanel.webview.postMessage({
    ...
    static updateTreasury(coins, activeLeaseSeconds, agreedCost, agreedLeaseSeconds) {
        if (this.currentPanel) {
            this.currentPanel.webview.postMessage({
    ...
    static notifyPermitGranted(seconds, remainingCoins) {
        if (this.currentPanel) {
            this.currentPanel.webview.postMessage({
                type: "PERMIT_GRANTED",
                seconds,
    ...
    static getHtmlForWebview(reversals, portName, initialCoins, activeLeaseSeconds, agreedCost, agreedLeaseSeconds) {
...
exports.StrikeModalManager = StrikeModalManager;
//# sourceMappingURL=strikeModal.js.map